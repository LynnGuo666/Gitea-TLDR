...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "username", sa.String(length=255), nullable=False, comment="Gitea 用户名"
        ),
        ...
        sa.Column(
            "permissions", sa.Text(), nullable=True, comment="权限配置（JSON格式）"
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "key_alias", sa.String(length=100), nullable=False, comment="Key 别名"
        ),
        sa.Column(
            "anthropic_base_url",
        ...
        sa.Column(
            ...
            sa.String(length=500),
            nullable=False,
            comment="Anthropic Auth Token（加密存储）",
        ),
        sa.Column(
            "priority",
            sa.Integer(),
        ...
        sa.Column("is_active", sa.Boolean(), nullable=False, comment="是否启用"),
        sa.Column(
            "daily_quota", sa.Integer(), nullable=True, comment="每日配额（Token数）"
        ),
        sa.Column(
            "monthly_quota", sa.Integer(), nullable=True, comment="每月配额（Token数）"
        ),
        ...
        sa.Column(
            "today_tokens", sa.Integer(), nullable=False, comment="今日Token消耗"
        ),
        sa.Column("month_calls", sa.Integer(), nullable=False, comment="本月调用次数"),
        sa.Column(
            "month_tokens", sa.Integer(), nullable=False, comment="本月Token消耗"
        ),
    ...
    op.create_index(
        op.f("ix_api_keys_key_alias"), "api_keys", ["key_alias"], unique=True
    )
    op.create_table(
        "webhook_logs",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=False,
            comment="完整的Webhook Payload（JSON格式）",
        ),
        sa.Column(
            "status",
            sa.String(length=20),
    ...
    op.create_index(
        op.f("ix_webhook_logs_repository_id"),
        "webhook_logs",
        ["repository_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_webhook_logs_request_id"), "webhook_logs", ["request_id"], unique=True
    )
    op.create_index(
